const project = {
  "slug": "ai-contract-sentinel",
  "title": "AI Contract Sentinel",
  "version": "1.0.0",
  "tagline": "Risk triage for AI-generated or AI-reviewed contracts.",
  "problem": "Contracts increasingly include AI-generated clauses, but parties need transparent checks for hallucinated obligations, missing provenance, and risky automated edits.",
  "solution": "A contract review manifest checker that validates source documents, reviewer role, clause risk tags, and unresolved human review items.",
  "required": [
    "contract.id",
    "contract.jurisdiction",
    "review.aiGeneratedClauses",
